...
export function ProductForm({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto bg-background border-border shadow-2xl">
        <DialogHeader className="relative">
          {/* Decorative header background */}
          <div className="absolute -top-6 -left-6 -right-6 h-16 bg-primary/10 rounded-t-lg" />
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6 relative z-10">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-semibold text-foreground">{t('form.productName')}</FormLabel>
                  <FormControl>
                    <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-semibold text-foreground">{t('form.description')}</FormLabel>
                  <FormControl>
                    <Input
            ...
            <FormItem>
              <FormLabel className="font-semibold text-foreground">{t('form.productImage')}</FormLabel>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  >
                    ...
                    <span>
                      {isUploading ? t('form.uploading') : t('form.chooseImage')}
                    </span>
                  </Button>
                  {uploadedImage && (
                    <Button
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-semibold text-foreground">{t('form.category')}</FormLabel>
                  <Select
            ...
            <div className="grid grid-cols-2 gap-4 p-4 rounded-xl border border-primary/20 bg-primary/5">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-semibold text-foreground">{t('form.purchasePrice')}</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-semibold text-foreground">{t('form.sellingPrice')}</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
            ...
            <div className="grid grid-cols-2 gap-4 p-4 rounded-xl border border-primary/20 bg-primary/5">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-semibold text-foreground">{t('form.currentStock')}</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        min="0"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-semibold text-foreground">{t('form.minThreshold')}</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        min="0"
            ...
            <div className="flex justify-end space-x-3 pt-6 border-t border-border">
              ...
              >
                {form.formState.isSubmitting
                  ? t('form.saving')
                  : editingProduct ? t('actions.edit') : t('form.save')
                }
              </Button>
            </div>
          </form>
